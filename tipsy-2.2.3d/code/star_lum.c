/* $Header: /share/src/hpcc/tipsy/code/star_lum.c,v 1.1.1.1 1995/01/10 22:57:28 trq Exp $
 * $Log: star_lum.c,v $
 * Revision 1.1.1.1  1995/01/10 22:57:28  trq
 * Import to CVS
 *
 * Revision 2.3  1994/12/05  17:49:20  trq
    ...
    double time ;
{
	...
	splinit(age,uuv_dat,uuv_fit,11,0.,0.) ;
	spline_loaded = 1 ;
    }
